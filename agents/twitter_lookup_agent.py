...
def lookup(name: str) -> str:
    ...
    template = """given the full name {name_of_person} I want you to get me a link to their Twitter profile page,
    ...
    tools_for_agent = [
        Tool(
            ...
            description="Useful for when you need get the Twitter page",
        )
    ]
